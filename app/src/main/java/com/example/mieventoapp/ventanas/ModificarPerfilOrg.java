...
public class ModificarPerfilOrg extends AppCompatActivity {
    ...
    private void Buttons(Usuarios u){
        bttnModificarPerfilOrg.setOnClickListener(new View.OnClickListener(){
            @Override
                ...
                if (checkEmpty.equals("")) {
                    ...
                    if (check.equals("")) {
                        if (pass.equals(u.getPassword())) {
                            ...
                            AlertDialog.Builder alert = new AlertDialog.Builder(ModificarPerfilOrg.this);
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    if (statusCode == 200){
                        ...
                        if (rs.equals("1")){
                            Toast.makeText(ModificarPerfilOrg.this,
                                    "Cuenta Modificada con exito!", Toast.LENGTH_LONG).show();
                            Intent i = new Intent(ModificarPerfilOrg.this, MainActivity.class);
                            loadingScreen.stopAnimation();
                            startActivity(i);
                            finish();
                        }
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (statusCode == 200){
                    try {
                        ...
                        AlertDialog.Builder msg = new AlertDialog.Builder(ModificarPerfilOrg.this);
