...
public class CrearCuentaOrg extends AppCompatActivity {
    ...
    /*Verifica que las valores ingresados por el usuario cumplan con los requerimientos.
    * Retorna un String (msg) con mensajes de error específicos de cada campo. Caso contrario
    * retorna ""*/
